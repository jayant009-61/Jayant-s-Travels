...
export const Yourbooking = ({ bus }) => {
  return (
    <><br /><br /><br /><br /><br /><br /><br />
      <center><h1>Your Bookings</h1></center><br />
      <center><hr className='hr' /></center><br /><br />
      ...
      <div className="tic">
        {
          bus.map((item) =>
            <div className='ticket'>
              ...
              <div className="hu">
                <div className="br">
                  <label htmlFor="m1"><h3>From:</h3></label>{item.loc}
                  <label htmlFor="m2"><h3>To:</h3></label>{item.des}
                </div><br />
                <div className="br"><label htmlFor="m3">Name: </label>{item.name} </div>
                <div className="br"><label htmlFor="m4">Age: </label>{item.age} </div>
                <div className="br"><label htmlFor="m5">Phone no.: </label>{item.phone} <br /></div>
                <div className="br"><label htmlFor="m6">Email ID: </label>{item.email} <br /></div>
                <div className="br"><label htmlFor="m7">Date: </label>{item.date} <br /></div>
              </div>
            </div>
          )
        }
